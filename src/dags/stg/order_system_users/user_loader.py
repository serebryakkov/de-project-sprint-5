...
class OrderSystemUserLoader:
    ...
    def __init__(self, collection_loader: OrderSystemUserReader, pg_dest: PgConnect, pg_saver: PgSaver, logger: Logger) -> None:
